<template>
  <UContainer>
    <div class="md:mx-auto">
      ...
      >
        <NuxtLink
          class="chapChin back cursor-pointer bg-cover hover:-translate-y-4 ease-in-out duration-300 relative w-72 lg:w-5/6 md:mx-auto mb-11 flex justify-center items-center rounded-lg h-96"
          to="/"
        >
          <div class="">
            <span class="font-black text-3xl text-white"> برگشت </span>
          </div>
        </NuxtLink>
        <div
          class="chapChin hover:-translate-y-4 ease-in-out duration-300 relative w-full lg:w-5/6 mx-auto"
          v-for="box in favoriteItems"
          :key="box.id"
        >
          <!-- ...1... -->
          <UCarousel
